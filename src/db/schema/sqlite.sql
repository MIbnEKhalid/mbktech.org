...
CREATE INDEX IF NOT EXISTS idx_mbkcore_support_submissions_page_url ON mbkcore_support_submissions (page_url);
CREATE INDEX IF NOT EXISTS idx_mbkcore_support_submissions_project_cat ON mbkcore_support_submissions (project_category);
